    ...
    return (
        <div className="SocialMediaLanding expertiseLanding">
            ...
            <main className="expertiseLandingHero">
                <div className="text">
                <h1><span className="expertiseLandingHeading">Beauty attracts the eyes but personality captures the heart.</span><br /> We create posts that are <span className="redText">good looking</span> and build your <span className="redText">identity</span>.</h1>
                <p>
