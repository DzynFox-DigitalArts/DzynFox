    ...
    return(
        <section className="ourExpertise">
            ...
            <div className="expertise-container">
                <ExpertiseTile name={"Graphic Design"} faIconName={"fas fa-bezier-curve"} desc={"Lorem ipsum dolor sit amet consectetur adipisicing elit."}/>
                ...
                <ExpertiseTile name={"Illustration"} faIconName={"fas fa-paint-brush"} desc={"Lorem ipsum dolor sit amet consectetur adipisicing elit."}/>
