...
const HeroSection = () => {
    return(
        <main className="AboutUsHeroMain">
            ...
            <p className="section-subheader subheader-main">We are designers.</p>
            <p className="section-subheader">We think. We plan. We create.<br />We conceive new ideas and bring them to reality.<br />We are creative artists but design things for a purpose</p>
            <div className="AboutUsHeroMainContent">
                <img src={AboutPNG} alt="Men Discussing Idea" />
                <div className="AboutUsHeroContent">
                    <p>
                    We are DzynFox Digital Arts LLP. A company formed under the MarkAll group of companies. We are the design hands of <span className='aboutus-subheader'>MarkAll - Marketing All Out</span>, a full-service marketing agency.
